...
struct GaugeCalculatorViewContractTests {
    ...
    @Test func projectPlacesJournalBetweenCountersAndCalculatorMenu() throws {
        let project = try appSource("KnitNote/Projects/ProjectDetailView.swift")
        ...
        #expect(journal.lowerBound < calculators.lowerBound)
    }
    ...
    @Test func gaugeResultsShowDensityExactAndRecommendation() throws {
        ...
        #expect(source.contains("\"calculator.gauge.recommendation.format\""))
        #expect(source.contains("LocaleAwareText.string"))
        #expect(source.contains("\"calculator.gauge.stitches.recommendation.format\""))
        #expect(source.contains("\"calculator.gauge.rows.recommendation.format\""))
