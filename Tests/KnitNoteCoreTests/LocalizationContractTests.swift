...
@Suite struct LocalizationContractTests {
    ...
    private let requiredJournalTranslations = [
        ...
        "journal.share": ["en": "Share", "zh-Hant": "分享"],
        "journal.share.title": ["en": "Share Knitting Journal", "zh-Hant": "分享編織日誌"],
        "journal.share.loading": ["en": "Creating preview…", "zh-Hant": "正在製作預覽…"],
        "journal.share.format": ["en": "Format", "zh-Hant": "格式"],
        "journal.share.format.post": ["en": "Post 4:5", "zh-Hant": "貼文 4:5"],
        "journal.share.format.story": ["en": "Story 9:16", "zh-Hant": "限時動態 9:16"],
        "journal.share.showProject": ["en": "Show project name", "zh-Hant": "顯示專案名稱"],
        "journal.share.showDate": ["en": "Show date", "zh-Hant": "顯示日期"],
        "journal.share.showCaption": ["en": "Show journal text", "zh-Hant": "顯示日誌文字"],
        "journal.share.showBrand": ["en": "Show KnitNote", "zh-Hant": "顯示 KnitNote"],
        "journal.share.text": ["en": "Post text", "zh-Hant": "貼文文字"],
        "journal.share.hashtag": ["en": "Include #KnitNote", "zh-Hant": "加入 #KnitNote"],
        "journal.share.action.share": ["en": "Share", "zh-Hant": "分享"],
        "journal.share.action.save": ["en": "Save to Photos", "zh-Hant": "儲存到照片"],
        "journal.share.action.saveFile": ["en": "Save Image…", "zh-Hant": "儲存圖片⋯"],
        "journal.share.action.copy": ["en": "Copy Post Text", "zh-Hant": "複製貼文文字"],
        "journal.share.preview.accessibility": ["en": "Knitting journal share card preview", "zh-Hant": "編織日誌分享卡預覽"],
        "journal.share.copyFeedback": ["en": "Copied", "zh-Hant": "已複製"],
        "journal.share.saving": ["en": "Saving…", "zh-Hant": "正在儲存…"],
        "journal.share.saved": ["en": "Saved to Photos", "zh-Hant": "已儲存到照片"],
        "journal.share.savedFile": ["en": "Image saved", "zh-Hant": "已儲存圖片"],
        "journal.share.saveCancelled": ["en": "Save cancelled", "zh-Hant": "已取消儲存"],
        "journal.share.openSettings": ["en": "Open Settings", "zh-Hant": "開啟設定"],
        "journal.share.error.title": ["en": "Unable to Share", "zh-Hant": "無法分享"],
        "journal.share.error.photoUnavailable": ["en": "This journal photo is unavailable.", "zh-Hant": "無法讀取這張日誌照片。"],
        "journal.share.error.render": ["en": "The share card couldn’t be created.", "zh-Hant": "無法製作分享卡。"],
        "journal.share.error.photosDenied": ["en": "Allow KnitNote to add photos in Settings to save this card.", "zh-Hant": "請在「設定」允許 KnitNote 新增照片，以儲存這張卡片。"],
        "journal.share.error.saveFailed": ["en": "The card couldn’t be saved to Photos.", "zh-Hant": "無法將卡片儲存到照片。"],
        "journal.share.error.saveFileFailed": ["en": "The image couldn’t be saved.", "zh-Hant": "無法儲存圖片。"],
        "journal.share.error.unavailable": ["en": "Sharing is temporarily unavailable.", "zh-Hant": "目前無法分享。"],
        "journal.share.announcement.copied": ["en": "Copied", "zh-Hant": "已複製"],
        "journal.share.announcement.failed": ["en": "Sharing is temporarily unavailable.", "zh-Hant": "目前無法分享。"],
        "journal.share.announcement.photoUnavailable": ["en": "This journal photo is unavailable.", "zh-Hant": "無法讀取這張日誌照片。"],
        "journal.share.announcement.renderFailed": ["en": "The share card couldn’t be created.", "zh-Hant": "無法製作分享卡。"],
        "journal.share.announcement.photosDenied": ["en": "Allow KnitNote to add photos in Settings to save this card.", "zh-Hant": "請在「設定」允許 KnitNote 新增照片，以儲存這張卡片。"],
        "journal.share.announcement.saved": ["en": "Saved to Photos", "zh-Hant": "已儲存到照片"],
        "journal.share.announcement.savedFile": ["en": "Image saved", "zh-Hant": "已儲存圖片"],
        "journal.share.announcement.saveFailed": ["en": "The card couldn’t be saved to Photos.", "zh-Hant": "無法將卡片儲存到照片。"],
        "journal.share.announcement.saveCancelled": ["en": "Save cancelled", "zh-Hant": "已取消儲存"],
    ]
    ...
    @Test func mainAppCatalogIsCompleteForVersion150Languages() throws {
        try assertCatalogMatchesOracle(
            ...
            permittedAdditionalKeys: [
                "stitchDictionary.cable-left-two.accessibility.1",
                "stitchDictionary.cable-left-two.accessibility.2",
                "stitchDictionary.cable-left-two.accessibility.3",
                "stitchDictionary.cable-left-two.step.1",
                "stitchDictionary.cable-left-two.step.2",
                "stitchDictionary.cable-left-two.step.3",
                "stitchDictionary.cable-left-two.summary",
                "stitchDictionary.cable-left-two.title",
                "stitchDictionary.cable-right-two.accessibility.1",
                "stitchDictionary.cable-right-two.accessibility.2",
                "stitchDictionary.cable-right-two.accessibility.3",
                "stitchDictionary.cable-right-two.step.1",
                "stitchDictionary.cable-right-two.step.2",
                "stitchDictionary.cable-right-two.step.3",
                "stitchDictionary.cable-right-two.summary",
                "stitchDictionary.cable-right-two.title",
                "stitchDictionary.centered-double-decrease.accessibility.1",
                "stitchDictionary.centered-double-decrease.accessibility.2",
                "stitchDictionary.centered-double-decrease.accessibility.3",
                "stitchDictionary.centered-double-decrease.step.1",
                "stitchDictionary.centered-double-decrease.step.2",
                "stitchDictionary.centered-double-decrease.step.3",
                "stitchDictionary.centered-double-decrease.summary",
                "stitchDictionary.centered-double-decrease.title",
                "stitchDictionary.detail.videos",
                "stitchDictionary.knit-front-back.accessibility.1",
                "stitchDictionary.knit-front-back.accessibility.2",
                "stitchDictionary.knit-front-back.accessibility.3",
                "stitchDictionary.knit-front-back.step.1",
                "stitchDictionary.knit-front-back.step.2",
                "stitchDictionary.knit-front-back.step.3",
                "stitchDictionary.knit-front-back.summary",
                "stitchDictionary.knit-front-back.title",
                "stitchDictionary.make-one-left.accessibility.1",
                "stitchDictionary.make-one-left.accessibility.2",
                "stitchDictionary.make-one-left.accessibility.3",
                "stitchDictionary.make-one-left.step.1",
                "stitchDictionary.make-one-left.step.2",
                "stitchDictionary.make-one-left.step.3",
                "stitchDictionary.make-one-left.summary",
                "stitchDictionary.make-one-left.title",
                "stitchDictionary.make-one-right.accessibility.1",
                "stitchDictionary.make-one-right.accessibility.2",
                "stitchDictionary.make-one-right.accessibility.3",
                "stitchDictionary.make-one-right.step.1",
                "stitchDictionary.make-one-right.step.2",
                "stitchDictionary.make-one-right.step.3",
                "stitchDictionary.make-one-right.summary",
                "stitchDictionary.make-one-right.title",
                "stitchDictionary.name.zh-Hans",
                "stitchDictionary.name.zh-Hant",
                "stitchDictionary.slip-knitwise.accessibility.1",
                "stitchDictionary.slip-knitwise.accessibility.2",
                "stitchDictionary.slip-knitwise.accessibility.3",
                "stitchDictionary.slip-knitwise.step.1",
                "stitchDictionary.slip-knitwise.step.2",
                "stitchDictionary.slip-knitwise.step.3",
                "stitchDictionary.slip-knitwise.summary",
                "stitchDictionary.slip-knitwise.title",
                "stitchDictionary.slip-purlwise.accessibility.1",
                "stitchDictionary.slip-purlwise.accessibility.2",
                "stitchDictionary.slip-purlwise.accessibility.3",
                "stitchDictionary.slip-purlwise.step.1",
                "stitchDictionary.slip-purlwise.step.2",
                "stitchDictionary.slip-purlwise.step.3",
                "stitchDictionary.slip-purlwise.summary",
                "stitchDictionary.slip-purlwise.title",
                "stitchDictionary.symbol.condition.centered-double-decrease",
                "stitchDictionary.symbol.condition.knit-front-back",
                "stitchDictionary.symbol.condition.slip-purlwise",
                "stitchDictionary.video.external",
                "stitchDictionary.video.language.en",
                "stitchDictionary.video.language.ja",
                "stitchDictionary.video.language.zxx",
                "stitchDictionary.video.watch",
                "stitchDictionary.yarn-over.accessibility.1",
                "stitchDictionary.yarn-over.accessibility.2",
                "stitchDictionary.yarn-over.accessibility.3",
                "stitchDictionary.yarn-over.step.1",
                "stitchDictionary.yarn-over.step.2",
                "stitchDictionary.yarn-over.step.3",
                "stitchDictionary.yarn-over.summary",
                "stitchDictionary.yarn-over.title",
                ...
                "stitchDictionary.cable-right-two.summary",
                "stitchDictionary.cable-right-two.title",
                "stitchDictionary.category.all",
                "stitchDictionary.category.basic",
                "stitchDictionary.category.cable",
                "stitchDictionary.category.decrease",
                "stitchDictionary.category.increase",
                "stitchDictionary.centered-double-decrease.accessibility.1",
                "stitchDictionary.centered-double-decrease.accessibility.2",
                "stitchDictionary.centered-double-decrease.accessibility.3",
                "stitchDictionary.centered-double-decrease.step.1",
                ...
                "stitchDictionary.centered-double-decrease.summary",
                "stitchDictionary.centered-double-decrease.title",
                "stitchDictionary.count.consumes",
                "stitchDictionary.count.net",
                "stitchDictionary.count.produces",
                "stitchDictionary.count.value",
                "stitchDictionary.detail.count",
                "stitchDictionary.detail.meaning",
                "stitchDictionary.detail.names",
                "stitchDictionary.detail.notes",
                "stitchDictionary.detail.related",
                "stitchDictionary.detail.sources",
                "stitchDictionary.detail.steps",
                "stitchDictionary.detail.symbols",
                "stitchDictionary.empty.clear",
                "stitchDictionary.empty.switchToList",
                "stitchDictionary.empty.title",
                "stitchDictionary.error.title",
                "stitchDictionary.k2tog.accessibility.1",
                "stitchDictionary.k2tog.accessibility.2",
                "stitchDictionary.k2tog.accessibility.3",
                "stitchDictionary.k2tog.step.1",
                "stitchDictionary.k2tog.step.2",
                "stitchDictionary.k2tog.step.3",
                "stitchDictionary.k2tog.summary",
                "stitchDictionary.k2tog.title",
                "stitchDictionary.knit-front-back.accessibility.1",
                "stitchDictionary.knit-front-back.accessibility.2",
                "stitchDictionary.knit-front-back.accessibility.3",
                "stitchDictionary.knit-front-back.step.1",
                ...
                "stitchDictionary.knit-front-back.summary",
                "stitchDictionary.knit-front-back.title",
                "stitchDictionary.knit.accessibility.1",
                "stitchDictionary.knit.accessibility.2",
                "stitchDictionary.knit.accessibility.3",
                "stitchDictionary.knit.accessibility.4",
                "stitchDictionary.knit.note.englishMethod",
                "stitchDictionary.knit.step.1",
                "stitchDictionary.knit.step.2",
                "stitchDictionary.knit.step.3",
                "stitchDictionary.knit.step.4",
                "stitchDictionary.knit.summary",
                "stitchDictionary.knit.title",
                "stitchDictionary.legend.arrow",
                "stitchDictionary.legend.cableNeedle",
                "stitchDictionary.legend.leftNeedle",
                "stitchDictionary.legend.newLoop",
                "stitchDictionary.legend.oldLoop",
                "stitchDictionary.legend.rightNeedle",
                "stitchDictionary.legend.title",
                "stitchDictionary.legend.workingYarn",
                "stitchDictionary.make-one-left.accessibility.1",
                "stitchDictionary.make-one-left.accessibility.2",
                "stitchDictionary.make-one-left.accessibility.3",
                "stitchDictionary.make-one-left.step.1",
                ...
                "stitchDictionary.make-one-right.summary",
                "stitchDictionary.make-one-right.title",
                "stitchDictionary.mode.list",
                "stitchDictionary.mode.symbols",
                "stitchDictionary.name.en",
                "stitchDictionary.name.ja",
                "stitchDictionary.name.ko",
                "stitchDictionary.name.zh-Hans",
                "stitchDictionary.name.zh-Hant",
                "stitchDictionary.note.cable",
                "stitchDictionary.note.context",
                "stitchDictionary.note.kfb",
                "stitchDictionary.note.koLegend",
                "stitchDictionary.note.legend",
                "stitchDictionary.note.slip",
                "stitchDictionary.note.sskSkp",
                "stitchDictionary.note.yarnOver",
                "stitchDictionary.p2tog.accessibility.1",
                "stitchDictionary.p2tog.accessibility.2",
                "stitchDictionary.p2tog.accessibility.3",
                "stitchDictionary.p2tog.step.1",
                "stitchDictionary.p2tog.step.2",
                "stitchDictionary.p2tog.step.3",
                "stitchDictionary.p2tog.summary",
                "stitchDictionary.p2tog.title",
                "stitchDictionary.purl.accessibility.1",
                "stitchDictionary.purl.accessibility.2",
                "stitchDictionary.purl.accessibility.3",
                "stitchDictionary.purl.step.1",
                "stitchDictionary.purl.step.2",
                "stitchDictionary.purl.step.3",
                "stitchDictionary.purl.summary",
                "stitchDictionary.purl.title",
                "stitchDictionary.repeat.format",
                "stitchDictionary.search.prompt",
                "stitchDictionary.skp.accessibility.1",
                "stitchDictionary.skp.accessibility.2",
                "stitchDictionary.skp.accessibility.3",
                "stitchDictionary.skp.step.1",
                "stitchDictionary.skp.step.2",
                "stitchDictionary.skp.step.3",
                "stitchDictionary.skp.summary",
                "stitchDictionary.skp.title",
                "stitchDictionary.slip-knitwise.accessibility.1",
                "stitchDictionary.slip-knitwise.accessibility.2",
                "stitchDictionary.slip-knitwise.accessibility.3",
                "stitchDictionary.slip-knitwise.step.1",
                ...
                "stitchDictionary.slip-purlwise.summary",
                "stitchDictionary.slip-purlwise.title",
                "stitchDictionary.ssk.accessibility.1",
                "stitchDictionary.ssk.accessibility.2",
                "stitchDictionary.ssk.accessibility.3",
                "stitchDictionary.ssk.step.1",
                "stitchDictionary.ssk.step.2",
                "stitchDictionary.ssk.step.3",
                "stitchDictionary.ssk.summary",
                "stitchDictionary.ssk.title",
                "stitchDictionary.step.format",
                "stitchDictionary.symbol.condition.centered-double-decrease",
                "stitchDictionary.symbol.condition.k2tog",
                "stitchDictionary.symbol.condition.knit-front-back",
                "stitchDictionary.symbol.condition.p2tog",
                "stitchDictionary.symbol.condition.purl",
                "stitchDictionary.symbol.condition.slip-purlwise",
                "stitchDictionary.symbol.condition.ssk",
                "stitchDictionary.symbol.cyc",
                "stitchDictionary.symbol.japanese",
                "stitchDictionary.symbol.korean",
                "stitchDictionary.symbol.koreanCondition",
                "stitchDictionary.symbol.rightSide",
                "stitchDictionary.symbol.unavailable",
                "stitchDictionary.title",
                "stitchDictionary.yarn-over.accessibility.1",
                "stitchDictionary.yarn-over.accessibility.2",
                "stitchDictionary.yarn-over.accessibility.3",
                "stitchDictionary.yarn-over.step.1",
    ...
    @Test func infoPlistCatalogIsCompleteForVersion150Languages() throws {
        try assertCatalogMatchesOracle(
            ...
            expectedSourceCommit: "f0116e0",
            permittedAdditionalKeys: ["NSPhotoLibraryAddUsageDescription"]
        )
        try assertCompleteCatalog(
            at: repositoryRoot.appending(
                path: "KnitNote/Localization/InfoPlist.xcstrings"
    ...
    private func journalSourceKeys() throws -> Set<String> {
        ...
        let sourceFiles = [
            ...
            "JournalPhotoPicker",
            "JournalSharing/JournalSharePreviewView",
        ]
