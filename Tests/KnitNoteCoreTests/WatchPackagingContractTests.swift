...
@Suite struct WatchPackagingContractTests {
    ...
    @Test func releaseCandidateUsesBuildTenAcrossEveryBundle() throws {
        ...
        #expect(!generatedProject.contains("CURRENT_PROJECT_VERSION = 9;"))
    }
